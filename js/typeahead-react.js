        ...
        return React.createElement(
            ...
            this.props.items.map(function (item, index) {
                return React.createElement(
                    ...
                    React.createElement(
                        "a",
                        { href: "#", onClick: _this.handleClick.bind(_this, index) },
                        React.createElement("i", { className: "fa fa-close" })
                    ),
                    React.createElement("input", { type: "hidden", name: idFormName, value: item[idName] }),
                    React.createElement("input", { type: "hidden", name: textFormName, value: item[textName] }),
...
var Typeahead = React.createClass({
    ...
    renderDropdown: function renderDropdown() {
        ...
        return React.createElement(
            "ul",
            { className: ulClassName, onMouseOut: this.handleMouseOut },
            ...
            this.state.filteredItems.length == 0 ? React.createElement(
                "li",
                null,
                " ",
                React.createElement(
    ...
    getExactMatchIdx: function getExactMatchIdx(query, resultList) {
    ...
    setDropdownList: function setDropdownList(query, resultList) {
    ...
    handleItemMouseOver: function handleItemMouseOver(index) {},
    ...
    isInArray: function isInArray(items, item) {
    ...
    render: function render() {
        return React.createElement(
            "div",
            { className: "mm-typeahead-wrapper" },
            React.createElement(
                "div",
                { className: "mm-typeahead", ref: "typeahed" },
                this.renderInput(),
                this.renderDropdown()
            ),
            React.createElement(SelectedItemList, { items: this.state.selectedItems, onRemoveSelectedItem: this.removeSelectedItem,
